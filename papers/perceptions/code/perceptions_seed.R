...
ranrd1<- rbind( c((format(round(sum(coefrd1[1,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd2[1,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd3[1,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd4[1,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd5[1,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd6[1,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd7[1,1]),digits=3),nsmall=0))),
                c((format(round(coefrd1[1,2],digits=3),nsmall=0)),
                  (format(round(coefrd2[1,2],digits=3),nsmall=0)),
                  (format(round(coefrd3[1,2],digits=3),nsmall=0)),
                  (format(round(coefrd4[1,2],digits=3),nsmall=0)),
                  (format(round(coefrd5[1,2],digits=3),nsmall=0)),
                  (format(round(coefrd6[1,2],digits=3),nsmall=0)),
                  (format(round(coefrd7[1,2],digits=3),nsmall=0))),
                c((format(round(coefrd1[1,4],digits=3),nsmall=0)),
                  (format(round(coefrd2[1,4],digits=3),nsmall=0)),
                  (format(round(coefrd3[1,4],digits=3),nsmall=0)),
                  (format(round(coefrd4[1,4],digits=3),nsmall=0)),
                  (format(round(coefrd5[1,4],digits=3),nsmall=0)),
                  (format(round(coefrd6[1,4],digits=3),nsmall=0)),
                  (format(round(coefrd7[1,4],digits=3),nsmall=0))),
                
                c((format(round(sum(coefrd1[2,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd2[2,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd3[2,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd4[2,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd5[2,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd6[2,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd7[2,1]),digits=3),nsmall=0))),
                c((format(round(coefrd1[2,2],digits=3),nsmall=0)),
                  (format(round(coefrd2[2,2],digits=3),nsmall=0)),
                  (format(round(coefrd3[2,2],digits=3),nsmall=0)),
                  (format(round(coefrd4[2,2],digits=3),nsmall=0)),
                  (format(round(coefrd5[2,2],digits=3),nsmall=0)),
                  (format(round(coefrd6[2,2],digits=3),nsmall=0)),
                  (format(round(coefrd7[2,2],digits=3),nsmall=0))),
                c((format(round(coefrd1[2,4],digits=3),nsmall=0)),
                  (format(round(coefrd2[2,4],digits=3),nsmall=0)),
                  (format(round(coefrd3[2,4],digits=3),nsmall=0)),
                  (format(round(coefrd4[2,4],digits=3),nsmall=0)),
                  (format(round(coefrd5[2,4],digits=3),nsmall=0)),
                  (format(round(coefrd6[2,4],digits=3),nsmall=0)),
                  (format(round(coefrd7[2,4],digits=3),nsmall=0))),
                
                
                c((format(round(summary(plmrd1)$r.squared[1],digits=3),nsmall=0)),
                  (format(round(summary(plmrd2)$r.squared[1],digits=3),nsmall=0)),
                  (format(round(summary(plmrd3)$r.squared[1],digits=3),nsmall=0)),
                  (format(round(summary(plmrd4)$r.squared[1],digits=3),nsmall=0)),
                  (format(round(summary(plmrd5)$r.squared[1],digits=3),nsmall=0)),
                  (format(round(summary(plmrd6)$r.squared[1],digits=3),nsmall=0)),
                  (format(round(summary(plmrd7)$r.squared[1],digits=3),nsmall=0))),
                c((format(round(summary(plmrd1)$r.squared[2],digits=3),nsmall=0)),
                  (format(round(summary(plmrd2)$r.squared[2],digits=3),nsmall=0)),
                  (format(round(summary(plmrd3)$r.squared[2],digits=3),nsmall=0)),
                  (format(round(summary(plmrd4)$r.squared[2],digits=3),nsmall=0)),
                  (format(round(summary(plmrd5)$r.squared[2],digits=3),nsmall=0)),
                  (format(round(summary(plmrd6)$r.squared[2],digits=3),nsmall=0)),
                  (format(round(summary(plmrd7)$r.squared[2],digits=3),nsmall=0))),
                c((format(round(nobs(plmrd1),digits=3),nsmall=0)),
                  (format(round(nobs(plmrd2),digits=3),nsmall=0)),
                  (format(round(nobs(plmrd3),digits=3),nsmall=0)),
                  (format(round(nobs(plmrd4),digits=3),nsmall=0)),
                  (format(round(nobs(plmrd5),digits=3),nsmall=0)),
                  (format(round(nobs(plmrd6),digits=3),nsmall=0)),
                  (format(round(nobs(plmrd7),digits=3),nsmall=0)))
)
...
ran_two1<- rbind( c((format(round(sum(coefr_two1[1,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two2[1,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two3[1,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two4[1,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two5[1,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two6[1,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two7[1,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two1[1,2],digits=3),nsmall=0)),
                    (format(round(coefr_two2[1,2],digits=3),nsmall=0)),
                    (format(round(coefr_two3[1,2],digits=3),nsmall=0)),
                    (format(round(coefr_two4[1,2],digits=3),nsmall=0)),
                    (format(round(coefr_two5[1,2],digits=3),nsmall=0)),
                    (format(round(coefr_two6[1,2],digits=3),nsmall=0)),
                    (format(round(coefr_two7[1,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two1[1,4],digits=3),nsmall=0)),
                    (format(round(coefr_two2[1,4],digits=3),nsmall=0)),
                    (format(round(coefr_two3[1,4],digits=3),nsmall=0)),
                    (format(round(coefr_two4[1,4],digits=3),nsmall=0)),
                    (format(round(coefr_two5[1,4],digits=3),nsmall=0)),
                    (format(round(coefr_two6[1,4],digits=3),nsmall=0)),
                    (format(round(coefr_two7[1,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two1[2,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two2[2,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two3[2,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two4[2,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two5[2,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two6[2,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two7[2,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two1[2,2],digits=3),nsmall=0)),
                    (format(round(coefr_two2[2,2],digits=3),nsmall=0)),
                    (format(round(coefr_two3[2,2],digits=3),nsmall=0)),
                    (format(round(coefr_two4[2,2],digits=3),nsmall=0)),
                    (format(round(coefr_two5[2,2],digits=3),nsmall=0)),
                    (format(round(coefr_two6[2,2],digits=3),nsmall=0)),
                    (format(round(coefr_two7[2,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two1[2,4],digits=3),nsmall=0)),
                    (format(round(coefr_two2[2,4],digits=3),nsmall=0)),
                    (format(round(coefr_two3[2,4],digits=3),nsmall=0)),
                    (format(round(coefr_two4[2,4],digits=3),nsmall=0)),
                    (format(round(coefr_two5[2,4],digits=3),nsmall=0)),
                    (format(round(coefr_two6[2,4],digits=3),nsmall=0)),
                    (format(round(coefr_two7[2,4],digits=3),nsmall=0))),
                  
                  
                  c((format(round(summary(plmr_two1)$r.squared[1],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two2)$r.squared[1],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two3)$r.squared[1],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two4)$r.squared[1],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two5)$r.squared[1],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two6)$r.squared[1],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two7)$r.squared[1],digits=3),nsmall=0))),
                  c((format(round(summary(plmr_two1)$r.squared[2],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two2)$r.squared[2],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two3)$r.squared[2],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two4)$r.squared[2],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two5)$r.squared[2],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two6)$r.squared[2],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two7)$r.squared[2],digits=3),nsmall=0))),
                  c((format(round(nobs(plmr_two1),digits=3),nsmall=0)),
                    (format(round(nobs(plmr_two2),digits=3),nsmall=0)),
                    (format(round(nobs(plmr_two3),digits=3),nsmall=0)),
                    (format(round(nobs(plmr_two4),digits=3),nsmall=0)),
                    (format(round(nobs(plmr_two5),digits=3),nsmall=0)),
                    (format(round(nobs(plmr_two6),digits=3),nsmall=0)),
                    (format(round(nobs(plmr_two7),digits=3),nsmall=0))))
...
plmr_two8<-plm(score ~ genderdummy +educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8  +maize.owner.agree.age +prim +maize.owner.agree.q3 +maize.owner.agree.q4+inputsale
               +years_shop +dedicated_area +pest_prob +insulated+ wall_heatproof +ventilation +
               ...
               effect = "twoway", random.method="walhus")
coefr_two8<-coeftest(plmr_two8, vcovHC(plmr_two8, type = "HC0", cluster = "time"))
summary(plmr_two8)
coefr_two8

plmr_two9<-plm(general ~ genderdummy +educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8  +maize.owner.agree.age +prim +maize.owner.agree.q3 +maize.owner.agree.q4+inputsale
               +years_shop +dedicated_area +pest_prob +insulated+ wall_heatproof +ventilation +
                 badlighting +badstored+ open_storage+ cert_yes+ shop_rate+ complaint + maize.owner.agree.q70 +leakproof, data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
               effect = "twoway", random.method="walhus")
coefr_two9<-coeftest(plmr_two9, vcovHC(plmr_two9, type = "HC0", cluster = "time"))
summary(plmr_two9)
coefr_two9

plmr_two10<-plm(yield ~ genderdummy +educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8  +maize.owner.agree.age +prim +maize.owner.agree.q3 +maize.owner.agree.q4+inputsale
               +years_shop +dedicated_area +pest_prob +insulated+ wall_heatproof +ventilation +
                 badlighting +badstored+ open_storage+ cert_yes+ shop_rate+ complaint + maize.owner.agree.q70 +leakproof, data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
               effect = "twoway", random.method="walhus")
coefr_two10<-coeftest(plmr_two10, vcovHC(plmr_two10, type = "HC0", cluster = "time"))
summary(plmr_two10)
coefr_two10

plmr_two11<-plm(drought_resistent ~ genderdummy +educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8  +maize.owner.agree.age +prim +maize.owner.agree.q3 +maize.owner.agree.q4+inputsale
                +years_shop +dedicated_area +pest_prob +insulated+ wall_heatproof +ventilation +
                  badlighting +badstored+ open_storage+ cert_yes+ shop_rate+ complaint + maize.owner.agree.q70 +leakproof, data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
                effect = "twoway", random.method="walhus")
coefr_two11<-coeftest(plmr_two11, vcovHC(plmr_two11, type = "HC0", cluster = "time"))
summary(plmr_two11)
coefr_two11

plmr_two12<-plm(disease_resistent ~ genderdummy +educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8  +maize.owner.agree.age +prim +maize.owner.agree.q3 +maize.owner.agree.q4+inputsale
                +years_shop +dedicated_area +pest_prob +insulated+ wall_heatproof +ventilation +
                  badlighting +badstored+ open_storage+ cert_yes+ shop_rate+ complaint + maize.owner.agree.q70 +leakproof, data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
                effect = "twoway", random.method="walhus")
coefr_two12<-coeftest(plmr_two12, vcovHC(plmr_two12, type = "HC0", cluster = "time"))
summary(plmr_two12)
coefr_two12

plmr_two13<-plm(early_maturing ~ genderdummy +educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8  +maize.owner.agree.age +prim +maize.owner.agree.q3 +maize.owner.agree.q4+inputsale
                +years_shop +dedicated_area +pest_prob +insulated+ wall_heatproof +ventilation +
                  badlighting +badstored+ open_storage+ cert_yes+ shop_rate+ complaint + maize.owner.agree.q70 +leakproof, data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
                effect = "twoway", random.method="walhus")
coefr_two13<-coeftest(plmr_two13, vcovHC(plmr_two13, type = "HC0", cluster = "time"))
summary(plmr_two13)
coefr_two13

plmr_two14<-plm(germination ~ genderdummy +educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8  +maize.owner.agree.age +prim +maize.owner.agree.q3 +maize.owner.agree.q4+inputsale
                +years_shop +dedicated_area +pest_prob +insulated+ wall_heatproof +ventilation +
                  badlighting +badstored+ open_storage+ cert_yes+ shop_rate+ complaint + maize.owner.agree.q70 +leakproof, data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
                effect = "twoway", random.method="walhus")
coefr_two14<-coeftest(plmr_two14, vcovHC(plmr_two14, type = "HC0", cluster = "time"))
summary(plmr_two14)
coefr_two14


ran_two2<- rbind( c((format(round(sum(coefr_two8[1,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[1,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[1,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[1,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[1,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[1,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[1,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[1,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[1,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[1,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[1,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[1,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[1,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[1,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[1,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[1,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[1,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[1,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[1,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[1,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[1,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[2,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[2,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[2,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[2,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[2,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[2,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[2,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[2,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[2,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[2,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[2,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[2,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[2,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[2,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[2,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[2,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[2,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[2,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[2,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[2,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[2,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[3,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[3,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[3,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[3,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[3,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[3,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[3,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[3,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[3,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[3,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[3,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[3,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[3,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[3,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[3,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[3,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[3,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[3,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[3,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[3,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[3,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[4,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[4,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[4,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[4,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[4,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[4,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[4,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[4,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[4,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[4,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[4,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[4,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[4,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[4,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[4,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[4,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[4,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[4,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[4,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[4,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[4,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[5,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[5,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[5,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[5,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[5,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[5,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[5,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[5,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[5,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[5,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[5,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[5,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[5,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[5,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[5,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[5,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[5,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[5,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[5,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[5,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[5,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[6,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[6,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[6,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[6,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[6,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[6,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[6,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[6,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[6,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[6,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[6,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[6,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[6,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[6,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[6,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[6,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[6,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[6,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[6,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[6,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[6,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[7,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[7,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[7,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[7,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[7,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[7,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[7,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[7,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[7,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[7,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[7,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[7,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[7,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[7,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[7,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[7,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[7,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[7,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[7,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[7,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[7,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[8,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[8,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[8,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[8,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[8,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[8,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[8,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[8,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[8,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[8,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[8,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[8,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[8,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[8,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[8,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[8,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[8,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[8,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[8,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[8,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[8,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[9,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[9,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[9,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[9,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[9,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[9,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[9,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[9,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[9,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[9,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[9,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[9,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[9,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[9,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[9,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[9,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[9,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[9,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[9,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[9,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[9,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[10,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[10,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[10,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[10,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[10,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[10,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[10,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[10,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[10,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[10,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[10,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[10,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[10,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[10,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[10,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[10,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[10,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[10,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[10,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[10,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[10,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[11,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[11,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[11,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[11,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[11,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[11,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[11,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[11,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[11,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[11,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[11,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[11,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[11,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[11,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[11,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[11,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[11,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[11,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[11,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[11,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[11,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[12,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[12,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[12,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[12,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[12,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[12,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[12,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[12,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[12,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[12,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[12,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[12,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[12,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[12,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[12,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[12,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[12,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[12,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[12,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[12,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[12,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[13,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[13,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[13,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[13,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[13,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[13,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[13,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[13,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[13,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[13,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[13,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[13,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[13,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[13,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[13,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[13,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[13,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[13,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[13,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[13,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[13,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[14,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[14,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[14,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[14,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[14,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[14,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[14,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[14,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[14,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[14,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[14,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[14,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[14,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[14,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[14,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[14,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[14,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[14,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[14,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[14,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[14,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[15,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[15,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[15,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[15,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[15,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[15,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[15,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[15,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[15,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[15,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[15,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[15,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[15,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[15,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[15,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[15,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[15,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[15,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[15,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[15,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[15,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[16,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[16,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[16,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[16,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[16,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[16,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[16,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[16,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[16,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[16,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[16,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[16,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[16,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[16,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[16,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[16,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[16,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[16,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[16,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[16,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[16,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[17,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[17,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[17,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[17,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[17,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[17,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[17,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[17,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[17,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[17,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[17,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[17,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[17,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[17,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[17,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[17,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[17,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[17,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[17,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[17,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[17,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[18,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[18,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[18,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[18,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[18,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[18,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[18,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[18,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[18,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[18,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[18,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[18,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[18,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[18,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[18,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[18,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[18,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[18,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[18,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[18,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[18,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[19,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[19,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[19,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[19,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[19,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[19,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[19,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[19,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[19,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[19,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[19,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[19,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[19,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[19,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[19,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[19,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[19,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[19,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[19,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[19,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[19,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[20,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[20,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[20,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[20,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[20,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[20,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[20,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[20,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[20,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[20,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[20,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[20,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[20,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[20,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[20,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[20,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[20,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[20,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[20,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[20,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[20,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[21,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[21,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[21,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[21,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[21,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[21,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[21,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[21,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[21,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[21,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[21,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[21,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[21,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[21,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[21,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[21,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[21,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[21,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[21,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[21,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[21,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[22,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[22,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[22,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[22,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[22,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[22,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[22,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[22,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[22,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[22,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[22,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[22,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[22,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[22,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[22,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[22,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[22,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[22,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[22,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[22,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[22,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[23,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[23,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[23,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[23,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[23,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[23,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[23,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[23,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[23,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[23,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[23,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[23,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[23,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[23,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[23,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[23,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[23,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[23,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[23,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[23,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[23,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[24,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[24,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[24,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[24,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[24,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[24,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[24,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[24,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[24,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[24,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[24,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[24,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[24,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[24,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[24,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[24,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[24,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[24,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[24,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[24,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[24,4],digits=3),nsmall=0))),
                  
                  c((format(round(sum(coefr_two8[25,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two9[25,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two10[25,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two11[25,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two12[25,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two13[25,1]),digits=3),nsmall=0)),
                    (format(round(sum(coefr_two14[25,1]),digits=3),nsmall=0))),
                  c((format(round(coefr_two8[25,2],digits=3),nsmall=0)),
                    (format(round(coefr_two9[25,2],digits=3),nsmall=0)),
                    (format(round(coefr_two10[25,2],digits=3),nsmall=0)),
                    (format(round(coefr_two11[25,2],digits=3),nsmall=0)),
                    (format(round(coefr_two12[25,2],digits=3),nsmall=0)),
                    (format(round(coefr_two13[25,2],digits=3),nsmall=0)),
                    (format(round(coefr_two14[25,2],digits=3),nsmall=0))),
                  c((format(round(coefr_two8[25,4],digits=3),nsmall=0)),
                    (format(round(coefr_two9[25,4],digits=3),nsmall=0)),
                    (format(round(coefr_two10[25,4],digits=3),nsmall=0)),
                    (format(round(coefr_two11[25,4],digits=3),nsmall=0)),
                    (format(round(coefr_two12[25,4],digits=3),nsmall=0)),
                    (format(round(coefr_two13[25,4],digits=3),nsmall=0)),
                    (format(round(coefr_two14[25,4],digits=3),nsmall=0))),
                  
                  
                  c((format(round(summary(plmr_two8)$r.squared[1],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two9)$r.squared[1],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two10)$r.squared[1],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two11)$r.squared[1],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two12)$r.squared[1],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two13)$r.squared[1],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two14)$r.squared[1],digits=3),nsmall=0))),
                  c((format(round(summary(plmr_two8)$r.squared[2],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two9)$r.squared[2],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two10)$r.squared[2],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two11)$r.squared[2],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two12)$r.squared[2],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two13)$r.squared[2],digits=3),nsmall=0)),
                    (format(round(summary(plmr_two14)$r.squared[2],digits=3),nsmall=0))),
                  c((format(round(nobs(plmr_two8),digits=3),nsmall=0)),
                    (format(round(nobs(plmr_two9),digits=3),nsmall=0)),
                    (format(round(nobs(plmr_two10),digits=3),nsmall=0)),
                    (format(round(nobs(plmr_two11),digits=3),nsmall=0)),
                    (format(round(nobs(plmr_two12),digits=3),nsmall=0)),
                    (format(round(nobs(plmr_two13),digits=3),nsmall=0)),
                    (format(round(nobs(plmr_two14),digits=3),nsmall=0))))
...
plmrd8<-plm(score ~ genderdummy+educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8 , data =fedata,  model = "random", index = c("shop_ID","farmer_ID"),
            effect = "individual", random.method="walhus")
coefrd8<-coeftest(plmrd8, vcovHC(plmrd8, type = "HC0", cluster = "time"))
summary(plmrd8)
coefrd8

plmrd9<-plm(general ~ genderdummy+educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8 , data =fedata,  model = "random", index = c("shop_ID","farmer_ID"),
            effect = "individual", random.method="walhus")
coefrd9<-coeftest(plmrd9, vcovHC(plmrd9, type = "HC0", cluster = "time"))
summary(plmrd9)
coefrd9

plmrd10<-plm(yield ~ genderdummy+educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8 , data =fedata,  model = "random", index = c("shop_ID","farmer_ID"),
            effect = "individual", random.method="walhus")
coefrd10<-coeftest(plmrd10, vcovHC(plmrd10, type = "HC0", cluster = "time"))
summary(plmrd10)
coefrd10

plmrd11<-plm(drought_resistent ~ genderdummy+educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8 , data =fedata,  model = "random", index = c("shop_ID","farmer_ID"),
            effect = "individual", random.method="walhus")
coefrd11<-coeftest(plmrd11, vcovHC(plmrd11, type = "HC0", cluster = "time"))
summary(plmrd11)
coefrd11

plmrd12<-plm(disease_resistent ~ genderdummy+educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8 , data =fedata,  model = "random", index = c("shop_ID","farmer_ID"),
            effect = "individual", random.method="walhus")
coefrd12<-coeftest(plmrd12, vcovHC(plmrd12, type = "HC0", cluster = "time"))
summary(plmrd12)
coefrd12

plmrd13<-plm(early_maturing ~ genderdummy+educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8 , data =fedata,  model = "random", index = c("shop_ID","farmer_ID"),
            effect = "individual", random.method="walhus")
coefrd13<-coeftest(plmrd13, vcovHC(plmrd13, type = "HC0", cluster = "time"))
summary(plmrd13)
coefrd13

plmrd14<-plm(germination ~ genderdummy+educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8 , data =fedata,  model = "random", index = c("shop_ID","farmer_ID"),
            effect = "individual", random.method="walhus")
coefrd14<-coeftest(plmrd14, vcovHC(plmrd14, type = "HC0", cluster = "time"))
summary(plmrd14)
coefrd14


ranrd2<- rbind( c((format(round(sum(coefrd8[1,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd9[1,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd10[1,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd11[1,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd12[1,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd13[1,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd14[1,1]),digits=3),nsmall=0))),
                c((format(round(coefrd8[1,2],digits=3),nsmall=0)),
                  (format(round(coefrd9[1,2],digits=3),nsmall=0)),
                  (format(round(coefrd10[1,2],digits=3),nsmall=0)),
                  (format(round(coefrd11[1,2],digits=3),nsmall=0)),
                  (format(round(coefrd12[1,2],digits=3),nsmall=0)),
                  (format(round(coefrd13[1,2],digits=3),nsmall=0)),
                  (format(round(coefrd14[1,2],digits=3),nsmall=0))),
                c((format(round(coefrd8[1,4],digits=3),nsmall=0)),
                  (format(round(coefrd9[1,4],digits=3),nsmall=0)),
                  (format(round(coefrd10[1,4],digits=3),nsmall=0)),
                  (format(round(coefrd11[1,4],digits=3),nsmall=0)),
                  (format(round(coefrd12[1,4],digits=3),nsmall=0)),
                  (format(round(coefrd13[1,4],digits=3),nsmall=0)),
                  (format(round(coefrd14[1,4],digits=3),nsmall=0))),
                
                c((format(round(sum(coefrd8[2,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd9[2,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd10[2,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd11[2,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd12[2,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd13[2,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd14[2,1]),digits=3),nsmall=0))),
                c((format(round(coefrd8[2,2],digits=3),nsmall=0)),
                  (format(round(coefrd9[2,2],digits=3),nsmall=0)),
                  (format(round(coefrd10[2,2],digits=3),nsmall=0)),
                  (format(round(coefrd11[2,2],digits=3),nsmall=0)),
                  (format(round(coefrd12[2,2],digits=3),nsmall=0)),
                  (format(round(coefrd13[2,2],digits=3),nsmall=0)),
                  (format(round(coefrd14[2,2],digits=3),nsmall=0))),
                c((format(round(coefrd8[2,4],digits=3),nsmall=0)),
                  (format(round(coefrd9[2,4],digits=3),nsmall=0)),
                  (format(round(coefrd10[2,4],digits=3),nsmall=0)),
                  (format(round(coefrd11[2,4],digits=3),nsmall=0)),
                  (format(round(coefrd12[2,4],digits=3),nsmall=0)),
                  (format(round(coefrd13[2,4],digits=3),nsmall=0)),
                  (format(round(coefrd14[2,4],digits=3),nsmall=0))),
                
                c((format(round(sum(coefrd8[3,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd9[3,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd10[3,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd11[3,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd12[3,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd13[3,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd14[3,1]),digits=3),nsmall=0))),
                c((format(round(coefrd8[3,2],digits=3),nsmall=0)),
                  (format(round(coefrd9[3,2],digits=3),nsmall=0)),
                  (format(round(coefrd10[3,2],digits=3),nsmall=0)),
                  (format(round(coefrd11[3,2],digits=3),nsmall=0)),
                  (format(round(coefrd12[3,2],digits=3),nsmall=0)),
                  (format(round(coefrd13[3,2],digits=3),nsmall=0)),
                  (format(round(coefrd14[3,2],digits=3),nsmall=0))),
                c((format(round(coefrd8[3,4],digits=3),nsmall=0)),
                  (format(round(coefrd9[3,4],digits=3),nsmall=0)),
                  (format(round(coefrd10[3,4],digits=3),nsmall=0)),
                  (format(round(coefrd11[3,4],digits=3),nsmall=0)),
                  (format(round(coefrd12[3,4],digits=3),nsmall=0)),
                  (format(round(coefrd13[3,4],digits=3),nsmall=0)),
                  (format(round(coefrd14[3,4],digits=3),nsmall=0))),
                
                c((format(round(sum(coefrd8[4,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd9[4,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd10[4,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd11[4,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd12[4,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd13[4,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd14[4,1]),digits=3),nsmall=0))),
                c((format(round(coefrd8[4,2],digits=3),nsmall=0)),
                  (format(round(coefrd9[4,2],digits=3),nsmall=0)),
                  (format(round(coefrd10[4,2],digits=3),nsmall=0)),
                  (format(round(coefrd11[4,2],digits=3),nsmall=0)),
                  (format(round(coefrd12[4,2],digits=3),nsmall=0)),
                  (format(round(coefrd13[4,2],digits=3),nsmall=0)),
                  (format(round(coefrd14[4,2],digits=3),nsmall=0))),
                c((format(round(coefrd8[4,4],digits=3),nsmall=0)),
                  (format(round(coefrd9[4,4],digits=3),nsmall=0)),
                  (format(round(coefrd10[4,4],digits=3),nsmall=0)),
                  (format(round(coefrd11[4,4],digits=3),nsmall=0)),
                  (format(round(coefrd12[4,4],digits=3),nsmall=0)),
                  (format(round(coefrd13[4,4],digits=3),nsmall=0)),
                  (format(round(coefrd14[4,4],digits=3),nsmall=0))),
                
                c((format(round(sum(coefrd8[5,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd9[5,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd10[5,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd11[5,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd12[5,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd13[5,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd14[5,1]),digits=3),nsmall=0))),
                c((format(round(coefrd8[5,2],digits=3),nsmall=0)),
                  (format(round(coefrd9[5,2],digits=3),nsmall=0)),
                  (format(round(coefrd10[5,2],digits=3),nsmall=0)),
                  (format(round(coefrd11[5,2],digits=3),nsmall=0)),
                  (format(round(coefrd12[5,2],digits=3),nsmall=0)),
                  (format(round(coefrd13[5,2],digits=3),nsmall=0)),
                  (format(round(coefrd14[5,2],digits=3),nsmall=0))),
                c((format(round(coefrd8[5,4],digits=3),nsmall=0)),
                  (format(round(coefrd9[5,4],digits=3),nsmall=0)),
                  (format(round(coefrd10[5,4],digits=3),nsmall=0)),
                  (format(round(coefrd11[5,4],digits=3),nsmall=0)),
                  (format(round(coefrd12[5,4],digits=3),nsmall=0)),
                  (format(round(coefrd13[5,4],digits=3),nsmall=0)),
                  (format(round(coefrd14[5,4],digits=3),nsmall=0))),
                
                c((format(round(sum(coefrd8[6,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd9[6,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd10[6,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd11[6,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd12[6,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd13[6,1]),digits=3),nsmall=0)),
                  (format(round(sum(coefrd14[6,1]),digits=3),nsmall=0))),
                c((format(round(coefrd8[6,2],digits=3),nsmall=0)),
                  (format(round(coefrd9[6,2],digits=3),nsmall=0)),
                  (format(round(coefrd10[6,2],digits=3),nsmall=0)),
                  (format(round(coefrd11[6,2],digits=3),nsmall=0)),
                  (format(round(coefrd12[6,2],digits=3),nsmall=0)),
                  (format(round(coefrd13[6,2],digits=3),nsmall=0)),
                  (format(round(coefrd14[6,2],digits=3),nsmall=0))),
                c((format(round(coefrd8[6,4],digits=3),nsmall=0)),
                  (format(round(coefrd9[6,4],digits=3),nsmall=0)),
                  (format(round(coefrd10[6,4],digits=3),nsmall=0)),
                  (format(round(coefrd11[6,4],digits=3),nsmall=0)),
                  (format(round(coefrd12[6,4],digits=3),nsmall=0)),
                  (format(round(coefrd13[6,4],digits=3),nsmall=0)),
                  (format(round(coefrd14[6,4],digits=3),nsmall=0))),
                
                
                
                c((format(round(summary(plmrd8)$r.squared[1],digits=3),nsmall=0)),
                  (format(round(summary(plmrd9)$r.squared[1],digits=3),nsmall=0)),
                  (format(round(summary(plmrd10)$r.squared[1],digits=3),nsmall=0)),
                  (format(round(summary(plmrd11)$r.squared[1],digits=3),nsmall=0)),
                  (format(round(summary(plmrd12)$r.squared[1],digits=3),nsmall=0)),
                  (format(round(summary(plmrd13)$r.squared[1],digits=3),nsmall=0)),
                  (format(round(summary(plmrd14)$r.squared[1],digits=3),nsmall=0))),
                c((format(round(summary(plmrd8)$r.squared[2],digits=3),nsmall=0)),
                  (format(round(summary(plmrd9)$r.squared[2],digits=3),nsmall=0)),
                  (format(round(summary(plmrd10)$r.squared[2],digits=3),nsmall=0)),
                  (format(round(summary(plmrd11)$r.squared[2],digits=3),nsmall=0)),
                  (format(round(summary(plmrd12)$r.squared[2],digits=3),nsmall=0)),
                  (format(round(summary(plmrd13)$r.squared[2],digits=3),nsmall=0)),
                  (format(round(summary(plmrd14)$r.squared[2],digits=3),nsmall=0))),
                c((format(round(nobs(plmrd8),digits=3),nsmall=0)),
                  (format(round(nobs(plmrd9),digits=3),nsmall=0)),
                  (format(round(nobs(plmrd10),digits=3),nsmall=0)),
                  (format(round(nobs(plmrd11),digits=3),nsmall=0)),
                  (format(round(nobs(plmrd12),digits=3),nsmall=0)),
                  (format(round(nobs(plmrd13),digits=3),nsmall=0)),
                  (format(round(nobs(plmrd14),digits=3),nsmall=0)))
)
...
plmn_two1<-plm(overall_rating ~ genderdummy , data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
           effect = "twoway", random.method = "walhus")
coefn_two1<-coeftest(plmn_two1, vcovHC(plmn_two1, type = "HC0", cluster = "time"))
summary(plmn_two1)
coefn_two1


plmn_two2<-plm(general_rating_nonseed ~ genderdummy , data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
               effect = "twoway", random.method = "walhus")
coefn_two2<-coeftest(plmn_two2, vcovHC(plmn_two2, type = "HC0", cluster = "time"))
summary(plmn_two2)
coefn_two2

plmn_two3<-plm(location ~ genderdummy , data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
               effect = "twoway", random.method = "walhus")
coefn_two3<-coeftest(plmn_two3, vcovHC(plmn_two3, type = "HC0", cluster = "time"))
summary(plmn_two3)
coefn_two3

plmn_two4<-plm(price ~ genderdummy , data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
               effect = "twoway", random.method = "walhus")
coefn_two4<-coeftest(plmn_two4, vcovHC(plmn_two4, type = "HC0", cluster = "time"))
summary(plmn_two4)
coefn_two4

plmn_two5<-plm(quality ~ genderdummy , data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
               effect = "twoway", random.method = "walhus")
coefn_two5<-coeftest(plmn_two5, vcovHC(plmn_two5, type = "HC0", cluster = "time"))
summary(plmn_two5)
coefn_two5

plmn_two6<-plm(stock ~ genderdummy , data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
               effect = "twoway", random.method = "walhus")
coefn_two6<-coeftest(plmn_two6, vcovHC(plmn_two6, type = "HC0", cluster = "time"))
summary(plmn_two6)
coefn_two6

plmn_two7<-plm(reputation ~ genderdummy , data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
               effect = "twoway", random.method = "walhus")
coefn_two7<-coeftest(plmn_two7, vcovHC(plmn_two7, type = "HC0", cluster = "time"))
summary(plmn_two7)
coefn_two7

rann_two1<- rbind( c((format(round(sum(coefn_two1[1,1]),digits=3),nsmall=0)),
                     (format(round(sum(coefn_two2[1,1]),digits=3),nsmall=0)),
                     (format(round(sum(coefn_two3[1,1]),digits=3),nsmall=0)),
                     (format(round(sum(coefn_two4[1,1]),digits=3),nsmall=0)),
                     (format(round(sum(coefn_two5[1,1]),digits=3),nsmall=0)),
                     (format(round(sum(coefn_two6[1,1]),digits=3),nsmall=0)),
                     (format(round(sum(coefn_two7[1,1]),digits=3),nsmall=0))),
                   c((format(round(coefn_two1[1,2],digits=3),nsmall=0)),
                     (format(round(coefn_two2[1,2],digits=3),nsmall=0)),
                     (format(round(coefn_two3[1,2],digits=3),nsmall=0)),
                     (format(round(coefn_two4[1,2],digits=3),nsmall=0)),
                     (format(round(coefn_two5[1,2],digits=3),nsmall=0)),
                     (format(round(coefn_two6[1,2],digits=3),nsmall=0)),
                     (format(round(coefn_two7[1,2],digits=3),nsmall=0))),
                   c((format(round(coefn_two1[1,4],digits=3),nsmall=0)),
                     (format(round(coefn_two2[1,4],digits=3),nsmall=0)),
                     (format(round(coefn_two3[1,4],digits=3),nsmall=0)),
                     (format(round(coefn_two4[1,4],digits=3),nsmall=0)),
                     (format(round(coefn_two5[1,4],digits=3),nsmall=0)),
                     (format(round(coefn_two6[1,4],digits=3),nsmall=0)),
                     (format(round(coefn_two7[1,4],digits=3),nsmall=0))),
                   
                   c((format(round(sum(coefn_two1[2,1]),digits=3),nsmall=0)),
                     (format(round(sum(coefn_two2[2,1]),digits=3),nsmall=0)),
                     (format(round(sum(coefn_two3[2,1]),digits=3),nsmall=0)),
                     (format(round(sum(coefn_two4[2,1]),digits=3),nsmall=0)),
                     (format(round(sum(coefn_two5[2,1]),digits=3),nsmall=0)),
                     (format(round(sum(coefn_two6[2,1]),digits=3),nsmall=0)),
                     (format(round(sum(coefn_two7[2,1]),digits=3),nsmall=0))),
                   c((format(round(coefn_two1[2,2],digits=3),nsmall=0)),
                     (format(round(coefn_two2[2,2],digits=3),nsmall=0)),
                     (format(round(coefn_two3[2,2],digits=3),nsmall=0)),
                     (format(round(coefn_two4[2,2],digits=3),nsmall=0)),
                     (format(round(coefn_two5[2,2],digits=3),nsmall=0)),
                     (format(round(coefn_two6[2,2],digits=3),nsmall=0)),
                     (format(round(coefn_two7[2,2],digits=3),nsmall=0))),
                   c((format(round(coefn_two1[2,4],digits=3),nsmall=0)),
                     (format(round(coefn_two2[2,4],digits=3),nsmall=0)),
                     (format(round(coefn_two3[2,4],digits=3),nsmall=0)),
                     (format(round(coefn_two4[2,4],digits=3),nsmall=0)),
                     (format(round(coefn_two5[2,4],digits=3),nsmall=0)),
                     (format(round(coefn_two6[2,4],digits=3),nsmall=0)),
                     (format(round(coefn_two7[2,4],digits=3),nsmall=0))),
                   
                   
                   c((format(round(summary(plmn_two1)$r.squared[1],digits=3),nsmall=0)),
                     (format(round(summary(plmn_two2)$r.squared[1],digits=3),nsmall=0)),
                     (format(round(summary(plmn_two3)$r.squared[1],digits=3),nsmall=0)),
                     (format(round(summary(plmn_two4)$r.squared[1],digits=3),nsmall=0)),
                     (format(round(summary(plmn_two5)$r.squared[1],digits=3),nsmall=0)),
                     (format(round(summary(plmn_two6)$r.squared[1],digits=3),nsmall=0)),
                     (format(round(summary(plmn_two7)$r.squared[1],digits=3),nsmall=0))),
                   c((format(round(summary(plmn_two1)$r.squared[2],digits=3),nsmall=0)),
                     (format(round(summary(plmn_two2)$r.squared[2],digits=3),nsmall=0)),
                     (format(round(summary(plmn_two3)$r.squared[2],digits=3),nsmall=0)),
                     (format(round(summary(plmn_two4)$r.squared[2],digits=3),nsmall=0)),
                     (format(round(summary(plmn_two5)$r.squared[2],digits=3),nsmall=0)),
                     (format(round(summary(plmn_two6)$r.squared[2],digits=3),nsmall=0)),
                     (format(round(summary(plmn_two7)$r.squared[2],digits=3),nsmall=0))),
                   c((format(round(nobs(plmn_two1),digits=3),nsmall=0)),
                     (format(round(nobs(plmn_two2),digits=3),nsmall=0)),
                     (format(round(nobs(plmn_two3),digits=3),nsmall=0)),
                     (format(round(nobs(plmn_two4),digits=3),nsmall=0)),
                     (format(round(nobs(plmn_two5),digits=3),nsmall=0)),
                     (format(round(nobs(plmn_two6),digits=3),nsmall=0)),
                     (format(round(nobs(plmn_two7),digits=3),nsmall=0))))
...
plmn_two8<-plm(overall_rating ~ genderdummy +educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8  +maize.owner.agree.age +prim +maize.owner.agree.q3 +maize.owner.agree.q4+inputsale
               +years_shop +dedicated_area +pest_prob +insulated+ wall_heatproof +ventilation +
                 badlighting +badstored+ open_storage+ cert_yes+ shop_rate+ complaint + maize.owner.agree.q70 +leakproof, data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
               effect = "twoway", random.method = "walhus")
coefn_two8<-coeftest(plmn_two8, vcovHC(plmn_two8, type = "HC0", cluster = "time"))
summary(plmn_two8)
coefn_two8

plmn_two9<-plm(general_rating_nonseed ~ genderdummy +educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8  +maize.owner.agree.age +prim +maize.owner.agree.q3 +maize.owner.agree.q4+inputsale
               +years_shop +dedicated_area +pest_prob +insulated+ wall_heatproof +ventilation +
                 badlighting +badstored+ open_storage+ cert_yes+ shop_rate+ complaint + maize.owner.agree.q70 +leakproof, data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
               effect = "twoway", random.method = "walhus")
coefn_two9<-coeftest(plmn_two9, vcovHC(plmn_two9, type = "HC0", cluster = "time"))
summary(plmn_two9)
coefn_two9

plmn_two10<-plm(location ~ genderdummy +educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8  +maize.owner.agree.age +prim +maize.owner.agree.q3 +maize.owner.agree.q4
               , data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
               effect = "twoway", random.method = "walhus")
coefn_two10<-coeftest(plmn_two10, vcovHC(plmn_two10, type = "HC0", cluster = "time"))
summary(plmn_two10)
coefn_two10

plmn_two11<-plm(price ~ genderdummy +educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8  +maize.owner.agree.age +prim +maize.owner.agree.q3 +maize.owner.agree.q4+inputsale
                +years_shop +dedicated_area +pest_prob +insulated+ wall_heatproof +ventilation +
                  badlighting +badstored+ open_storage+ cert_yes+ shop_rate+ complaint + maize.owner.agree.q70 +leakproof
                , data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
                effect = "twoway", random.method = "walhus")
coefn_two11<-coeftest(plmn_two11, vcovHC(plmn_two11, type = "HC0", cluster = "time"))
summary(plmn_two11)
coefn_two11

plmn_two12<-plm(quality~ genderdummy +educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8  +maize.owner.agree.age +prim +maize.owner.agree.q3 +maize.owner.agree.q4+inputsale
                +years_shop +dedicated_area +pest_prob +insulated+ wall_heatproof +ventilation +
                  badlighting +badstored+ open_storage+ cert_yes+ shop_rate+ complaint + maize.owner.agree.q70 +leakproof
                , data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
                effect = "twoway", random.method = "walhus")
coefn_two12<-coeftest(plmn_two12, vcovHC(plmn_two12, type = "HC0", cluster = "time"))
summary(plmn_two12)
coefn_two12

plmn_two13<-plm(stock~ genderdummy +educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8  +maize.owner.agree.age +prim +maize.owner.agree.q3 +maize.owner.agree.q4
                , data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
                effect = "twoway", random.method = "walhus")
coefn_two13<-coeftest(plmn_two13, vcovHC(plmn_two13, type = "HC0", cluster = "time"))
summary(plmn_two13)
coefn_two13

plmn_two14<-plm(reputation ~ genderdummy +educ_f+married+Check2.check.maize.q14+Check2.check.maize.q8  +maize.owner.agree.age +prim +maize.owner.agree.q3 +maize.owner.agree.q4+inputsale
                +years_shop +dedicated_area +pest_prob +insulated+ wall_heatproof +ventilation +
                  badlighting +badstored+ open_storage+ cert_yes+ shop_rate+ complaint + maize.owner.agree.q70 +leakproof
                , data =fedata,  model = "random", index = c( "farmer_ID", "shop_ID"),
                effect = "twoway", random.method = "walhus")
coefn_two14<-coeftest(plmn_two14, vcovHC(plmn_two14, type = "HC0", cluster = "time"))
summary(plmn_two14)
coefn_two14
