...
s2<- rbind(c((format(round(sum(m9$coefficients[1]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[1]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[1]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[1]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[1]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[1]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[1]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[1]),digits=2),nsmall=0))),
           c((format(round(se9[1],digits=2),nsmall=0)),
             (format(round(se10[1],digits=2),nsmall=0)),
             (format(round(se11[1],digits=2),nsmall=0)),
             (format(round(se12[1],digits=2),nsmall=0)),
             (format(round(se13[1],digits=2),nsmall=0)),
             (format(round(se14[1],digits=2),nsmall=0)),
             (format(round(se15[1],digits=2),nsmall=0)),
             (format(round(se16[1],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[1,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[1,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[1,4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[1,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[1,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[1,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[1,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[1,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[2]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[2]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[2]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[2]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[2]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[2]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[2]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[2]),digits=2),nsmall=0))),
           c((format(round(se9[2],digits=2),nsmall=0)),
             (format(round(se10[2],digits=2),nsmall=0)),
             (format(round(se11[2],digits=2),nsmall=0)),
             (format(round(se12[2],digits=2),nsmall=0)),
             (format(round(se13[2],digits=2),nsmall=0)),
             (format(round(se14[2],digits=2),nsmall=0)),
             (format(round(se15[2],digits=2),nsmall=0)),
             (format(round(se16[2],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[2,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[2,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[2,4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[2,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[2,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[2,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[2,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[2,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[3]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[3]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[3]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[3]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[3]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[3]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[3]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[3]),digits=2),nsmall=0))),
           c((format(round(se9[3],digits=2),nsmall=0)),
             (format(round(se10[3],digits=2),nsmall=0)),
             (format(round(se11[3],digits=2),nsmall=0)),
             (format(round(se12[3],digits=2),nsmall=0)),
             (format(round(se13[3],digits=2),nsmall=0)),
             (format(round(se14[3],digits=2),nsmall=0)),
             (format(round(se15[3],digits=2),nsmall=0)),
             (format(round(se16[3],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[3,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[3,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[3,4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[3,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[3,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[3,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[3,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[3,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[4]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[4]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[4]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[4]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[4]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[4]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[4]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[4]),digits=2),nsmall=0))),
           c((format(round(se9[4],digits=2),nsmall=0)),
             (format(round(se10[4],digits=2),nsmall=0)),
             (format(round(se11[4],digits=2),nsmall=0)),
             (format(round(se12[4],digits=2),nsmall=0)),
             (format(round(se13[4],digits=2),nsmall=0)),
             (format(round(se14[4],digits=2),nsmall=0)),
             (format(round(se15[4],digits=2),nsmall=0)),
             (format(round(se16[4],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[4,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[4,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[4,4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[4,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[4,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[4,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[4,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[4,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[5]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[5]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[5]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[5]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[5]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[5]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[5]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[5]),digits=2),nsmall=0))),
           c((format(round(se9[5],digits=2),nsmall=0)),
             (format(round(se10[5],digits=2),nsmall=0)),
             (format(round(se11[5],digits=2),nsmall=0)),
             (format(round(se12[5],digits=2),nsmall=0)),
             (format(round(se13[5],digits=2),nsmall=0)),
             (format(round(se14[5],digits=2),nsmall=0)),
             (format(round(se15[5],digits=2),nsmall=0)),
             (format(round(se16[5],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[5,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[5,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[5,4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[5,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[5,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[5,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[5,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[5,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[6]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[6]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[6]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[6]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[6]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[6]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[6]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[6]),digits=2),nsmall=0))),
           c((format(round(se9[6],digits=2),nsmall=0)),
             (format(round(se10[6],digits=2),nsmall=0)),
             (format(round(se11[6],digits=2),nsmall=0)),
             (format(round(se12[6],digits=2),nsmall=0)),
             (format(round(se13[6],digits=2),nsmall=0)),
             (format(round(se14[6],digits=2),nsmall=0)),
             (format(round(se15[6],digits=2),nsmall=0)),
             (format(round(se16[6],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[6,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[6,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[6,4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[6,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[6,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[6,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[6,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[6,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[7]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[7]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[7]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[7]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[7]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[7]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[7]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[7]),digits=2),nsmall=0))),
           c((format(round(se9[7],digits=2),nsmall=0)),
             (format(round(se10[7],digits=2),nsmall=0)),
             (format(round(se11[7],digits=2),nsmall=0)),
             (format(round(se12[7],digits=2),nsmall=0)),
             (format(round(se13[7],digits=2),nsmall=0)),
             (format(round(se14[7],digits=2),nsmall=0)),
             (format(round(se15[7],digits=2),nsmall=0)),
             (format(round(se16[7],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[7,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[7,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[7,4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[7,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[7,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[7,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[7,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[7,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[8]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[8]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[8]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[8]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[8]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[8]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[8]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[8]),digits=2),nsmall=0))),
           c((format(round(se9[8],digits=2),nsmall=0)),
             (format(round(se10[8],digits=2),nsmall=0)),
             (format(round(se11[8],digits=2),nsmall=0)),
             (format(round(se12[8],digits=2),nsmall=0)),
             (format(round(se13[8],digits=2),nsmall=0)),
             (format(round(se14[8],digits=2),nsmall=0)),
             (format(round(se15[8],digits=2),nsmall=0)),
             (format(round(se16[8],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[8,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[8,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[8,4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[8,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[8,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[8,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[8,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[8,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[9]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[9]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[9]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[9]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[9]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[9]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[9]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[9]),digits=2),nsmall=0))),
           c((format(round(se9[9],digits=2),nsmall=0)),
             (format(round(se10[9],digits=2),nsmall=0)),
             (format(round(se11[9],digits=2),nsmall=0)),
             (format(round(se12[9],digits=2),nsmall=0)),
             (format(round(se13[9],digits=2),nsmall=0)),
             (format(round(se14[9],digits=2),nsmall=0)),
             (format(round(se15[9],digits=2),nsmall=0)),
             (format(round(se16[9],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[9,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[9,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[9,4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[9,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[9,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[9,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[9,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[9,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[10]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[10]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[10]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[10]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[10]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[10]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[10]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[10]),digits=2),nsmall=0))),
           c((format(round(se9[10],digits=2),nsmall=0)),
             (format(round(se10[10],digits=2),nsmall=0)),
             (format(round(se11[10],digits=2),nsmall=0)),
             (format(round(se12[10],digits=2),nsmall=0)),
             (format(round(se13[10],digits=2),nsmall=0)),
             (format(round(se14[10],digits=2),nsmall=0)),
             (format(round(se15[10],digits=2),nsmall=0)),
             (format(round(se16[10],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[10,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[10,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[10,4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[10,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[10,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[10,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[10,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[10,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[11]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[11]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[11]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[11]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[11]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[11]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[11]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[11]),digits=2),nsmall=0))),
           c((format(round(se9[11],digits=2),nsmall=0)),
             (format(round(se10[11],digits=2),nsmall=0)),
             (format(round(se11[11],digits=2),nsmall=0)),
             (format(round(se12[11],digits=2),nsmall=0)),
             (format(round(se13[11],digits=2),nsmall=0)),
             (format(round(se14[11],digits=2),nsmall=0)),
             (format(round(se15[11],digits=2),nsmall=0)),
             (format(round(se16[11],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[11,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[11,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[11,4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[11,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[11,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[11,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[11,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[11,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[12]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[12]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[12]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[12]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[12]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[12]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[12]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[12]),digits=2),nsmall=0))),
           c((format(round(se9[12],digits=2),nsmall=0)),
             (format(round(se10[12],digits=2),nsmall=0)),
             (format(round(se11[12],digits=2),nsmall=0)),
             (format(round(se12[12],digits=2),nsmall=0)),
             (format(round(se13[12],digits=2),nsmall=0)),
             (format(round(se14[12],digits=2),nsmall=0)),
             (format(round(se15[12],digits=2),nsmall=0)),
             (format(round(se16[12],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[12,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[12,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[12,4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[12,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[12,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[12,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[12,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[12,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[13]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[13]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[13]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[13]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[13]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[13]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[13]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[13]),digits=2),nsmall=0))),
           c((format(round(se9[13],digits=2),nsmall=0)),
             (format(round(se10[13],digits=2),nsmall=0)),
             (format(round(se11[13],digits=2),nsmall=0)),
             (format(round(se12[13],digits=2),nsmall=0)),
             (format(round(se13[13],digits=2),nsmall=0)),
             (format(round(se14[13],digits=2),nsmall=0)),
             (format(round(se15[13],digits=2),nsmall=0)),
             (format(round(se16[13],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[13,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[13,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[13,4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[13,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[13,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[13,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[13,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[13,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[14]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[14]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[14]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[14]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[14]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[14]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[14]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[14]),digits=2),nsmall=0))),
           c((format(round(se9[14],digits=2),nsmall=0)),
             (format(round(se10[14],digits=2),nsmall=0)),
             (format(round(se11[14],digits=2),nsmall=0)),
             (format(round(se12[14],digits=2),nsmall=0)),
             (format(round(se13[14],digits=2),nsmall=0)),
             (format(round(se14[14],digits=2),nsmall=0)),
             (format(round(se15[14],digits=2),nsmall=0)),
             (format(round(se16[14],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[14,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[14,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[14,4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[14,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[14,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[14,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[14,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[14,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[15]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[15]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[15]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[15]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[15]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[15]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[15]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[15]),digits=2),nsmall=0))),
           c((format(round(se9[15],digits=2),nsmall=0)),
             (format(round(se10[15],digits=2),nsmall=0)),
             (format(round(se11[15],digits=2),nsmall=0)),
             (format(round(se12[15],digits=2),nsmall=0)),
             (format(round(se13[15],digits=2),nsmall=0)),
             (format(round(se14[15],digits=2),nsmall=0)),
             (format(round(se15[15],digits=2),nsmall=0)),
             (format(round(se16[15],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[15,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[15,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[15,4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[15,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[15,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[15,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[15,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[15,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[16]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[16]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[16]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[16]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[16]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[16]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[16]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[16]),digits=2),nsmall=0))),
           c((format(round(se9[16],digits=2),nsmall=0)),
             (format(round(se10[16],digits=2),nsmall=0)),
             (format(round(se11[16],digits=2),nsmall=0)),
             (format(round(se12[16],digits=2),nsmall=0)),
             (format(round(se13[16],digits=2),nsmall=0)),
             (format(round(se14[16],digits=2),nsmall=0)),
             (format(round(se15[16],digits=2),nsmall=0)),
             (format(round(se16[16],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[16,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[16,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[16.4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[16,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[16,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[16,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[16,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[16,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[17]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[17]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[17]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[17]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[17]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[17]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[17]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[17]),digits=2),nsmall=0))),
           c((format(round(se9[17],digits=2),nsmall=0)),
             (format(round(se10[17],digits=2),nsmall=0)),
             (format(round(se11[17],digits=2),nsmall=0)),
             (format(round(se12[17],digits=2),nsmall=0)),
             (format(round(se13[17],digits=2),nsmall=0)),
             (format(round(se14[17],digits=2),nsmall=0)),
             (format(round(se15[17],digits=2),nsmall=0)),
             (format(round(se16[17],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[17,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[17,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[16.4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[17,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[17,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[17,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[17,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[17,4],digits=2),nsmall=0))),
           
           c((format(round(sum(m9$coefficients[18]),digits=2),nsmall=0)),
             (format(round(sum(m10$coefficients[18]),digits=2),nsmall=0)),
             (format(round(sum(m11$coefficients[18]),digits=2),nsmall=0)),
             (format(round(sum(m12$coefficients[18]),digits=2),nsmall=0)),
             (format(round(sum(m13$coefficients[18]),digits=2),nsmall=0)),
             (format(round(sum(m14$coefficients[18]),digits=2),nsmall=0)),
             (format(round(sum(m15$coefficients[18]),digits=2),nsmall=0)),
             (format(round(sum(m16$coefficients[18]),digits=2),nsmall=0))),
           c((format(round(se9[18],digits=2),nsmall=0)),
             (format(round(se10[18],digits=2),nsmall=0)),
             (format(round(se11[18],digits=2),nsmall=0)),
             (format(round(se12[18],digits=2),nsmall=0)),
             (format(round(se13[18],digits=2),nsmall=0)),
             (format(round(se14[18],digits=2),nsmall=0)),
             (format(round(se15[18],digits=2),nsmall=0)),
             (format(round(se16[18],digits=2),nsmall=0))),
           c((format(round(summary(m9)$coefficients[18,4],digits=2),nsmall=0)),
             (format(round(summary(m10)$coefficients[18,4],digits=2),nsmall=0)),
             (format(round(summary(m11)$coefficients[16.4],digits=2),nsmall=0)),
             (format(round(summary(m12)$coefficients[18,4],digits=2),nsmall=0)),
             (format(round(summary(m13)$coefficients[18,4],digits=2),nsmall=0)),
             (format(round(summary(m14)$coefficients[18,4],digits=2),nsmall=0)),
             (format(round(summary(m15)$coefficients[18,4],digits=2),nsmall=0)),
             (format(round(summary(m16)$coefficients[18,4],digits=2),nsmall=0))),
