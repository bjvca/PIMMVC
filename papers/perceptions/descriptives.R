...
baseline_dealers <- read.csv(paste(path,"/data_seed_systems/data/input_dealer/baseline_dealer.csv",sep="/"))
baseline_farmers <- read.csv(paste(path,"/data_seed_systems/data/farmer/baseline_farmers.csv",sep="/"))
...
#farmers
rating_dyads <- read.csv(paste(path,"/data_seed_systems/data/farmer/rating_dyads.csv",sep="/"))
...
#BASELINE
dealer_services_dyads <- read.csv(paste(path,"/data_seed_systems/data/farmer/dealer_services_dyads.csv",sep="/"))
